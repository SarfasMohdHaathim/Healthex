            ...
            <div class="card-header ">
              <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                  <h5 class="mb-0" data-anchor="data-anchor" id="file-input">EDIT PRODUCT<a class="anchorjs-link " aria-label="Anchor" data-anchorjs-icon="#" href="#file-input" style="padding-left: 0.375em;"></a></h5>
                </div>
            ...
            <div class="card-body bg-light">
              <div class="tab-content">
                ...
                <div class="mb-3 w-50">
                    ...
                    <label class="form-label text-info" for="customFile"><?php echo $image_url ?></label>
                ...
                <div class="mb-3 w-50">
                    ...
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="des"><?php echo $des ?></textarea>
                </div>
                <div class="mb-3 w-50">
