...
<div class="card mb-3">
            <div class="card-header ">
              <div class="row flex-between-end">
                <div class="col-auto align-self-center">
                  <h5 class="mb-0" data-anchor="data-anchor" id="file-input">ADD BLOG<a class="anchorjs-link " aria-label="Anchor" data-anchorjs-icon="#" href="#file-input" style="padding-left: 0.375em;"></a></h5>
                </div>
            ...
            <div class="card-body bg-light">
              ...
              <form action="php/upload-blog.php" method="POST" enctype="multipart/form-data" >
                ...
                <div class="mb-3 w-50 ">
                    ...
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="2" name="des"></textarea>
                </div>
                <div class="mb-3 w-50 ">
                    <label class="form-label" for="exampleFormControlTextarea1">Pharagraph 1</label>
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="5" name="p1"></textarea>
                </div>
                <div class="mb-3 w-50 ">
                    <label class="form-label" for="exampleFormControlTextarea1">Pharagraph 2</label>
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="5" name="p2"></textarea>
                </div>
                <div class="mb-3 w-50">
                    <label class="form-label" for="exampleFormControlTextarea1">Pharagraph 3</label>
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="5" name="p3"></textarea>
                </div>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            addParagraphBtn.addEventListener("click", function() {
                if (currentParagraph <= totalParagraphs) {
                    var hiddenTextareas = document.getElementsByClassName("hidden");
                    if (hiddenTextareas.length > 0) {
                        hiddenTextareas[0].classList.remove("hidden");
                    }
                    currentParagraph++;
                }

                if (currentParagraph > totalParagraphs) {
                    addParagraphBtn.style.display = "none";
                }
            });
        });
    </script>
