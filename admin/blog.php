            ...
            <div class="card-body bg-light">
                    ...
                    <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-9b51b3a6-b7fa-416c-9f5f-0fbd5384b04a" id="dom-9b51b3a6-b7fa-416c-9f5f-0fbd5384b04a">
                      <div class="card overflow-hidden" style="width: 20rem;">
                        ...
                        <div class="card-body">
                          ...
                          <a class="btn btn-falcon-info btn-sm"  href="edit-blog.php?id=<?=$row['id']?>">Edit</a>
                          <a class="btn btn-falcon-info btn-sm"  href="view-blog.php?id=<?=$row['id']?>">Detail View</a>
                        </div>
                        </div>
                      </div>
                    </div>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="php/delete-blog.php?id=<?=$row['id']?>" type="button" class="btn btn-danger">Delete</a>
                    </div>
                    </div>
                </div>
                </div>
